...
/**
 * Ropsten ERC721 
 * Outlands Planes Registrar - 0xC6B43DfbE2acB52ee930f13a1a36E0F871F0320B
 */
 ...
 * 
 * Ropsten - 0x3B54797E3E34461C1d3C7A56631c0ffa2E02b4aB
 *
 */
contract CPXRegistry is MinterRole {
    ...
    constructor() public {
        ...
        _nfts.push(0xC6B43DfbE2acB52ee930f13a1a36E0F871F0320B);
    }
    ...
    function mintNFTWithURI(uint256 _i, address _who, string memory tokenURI) public onlyMinter returns(uint256 tokenId) {
        //require the token to be the next one 
        tokenId = ICPX721(_nfts[_i]).currentID();
        ICPX721(_nfts[_i]).mintWithTokenURI(_who, tokenURI);
    }
    ...
    function _burnToken(uint256 _i, address _who, uint256 _amt, bytes memory _data, bytes memory _opData) internal {
        //check for value 
        require(ICPX777(_tokens[_i]).balanceOf(_who) >= _amt, "Not enough Balance");
