...
contract OutlandsInternalToken is MinterRole
{
...
/////////////////////////////////////////// ERC1155 //////////////////////////////////////////////
    ...
    //mint token 
    function mint(uint256 _id, address[] calldata _to, uint256[] calldata _quantities) external onlyMinter {
    ...
    */
    function safeTransferFrom(address _from, address _to, uint256 _id, uint256 _value) external {
        ...
        require(_from == msg.sender || isMinter(msg.sender), "Need operator approval for 3rd party transfers.");
